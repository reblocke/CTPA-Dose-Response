...
log using "`output_dir'/Logs/(`a1'_`a2'_`a3')BL CombofilewithoutEMPI.log", replace text

local final_data "`input_root'/final_noempi.dta"
local cleaned_data "`output_dir'/cleaned_noempi.dta"
...
graph export "`output_dir'/Hist Time of Death PAd status.png", as(png) name("Graph") replace
hist lastfollowupyear if death == 1, by(enlargedratio) xtitle("Time of death, by PA:AA ratio status (years)")
graph export "`output_dir'/Hist Time of Death PAAA status.png", as(png) name("Graph") replace
...
save "`output_dir'/finalwithfollowupandcovariates_noempi.dta", replace
...
saving("`output_dir'/PA enlargement by Age.xlsx", replace)
...
percent_n percsign("%") iqrmiddle(",") sdleft(" (±") sdright(")") onecol total(before) ///
saving("`output_dir'/Table 1a - main demographics PAd.xlsx", replace)
...
percent_n percsign("%") iqrmiddle(",") sdleft(" (±") sdright(")") onecol total(before) ///
saving("`output_dir'/Table 1b - main demographics PAAA.xlsx", replace)
//Took out:
...
percent_n percsign("%") iqrmiddle(",") sdleft(" (±") sdright(")") onecol total(before) ///
saving("`output_dir'/Table 3 - main demographics by death.xlsx", replace)
//Took out:
//obesity bin %4.1f \ ///
//pulmonarycircdisorders bin %4.1f \ ///
//peripheralvascdisorders bin %4.1f \ ///
...
percent_n percsign("%") iqrmiddle(",") sdleft(" (±") sdright(")") onecol total(before) ///
saving("`output_dir'/All demographcis by PAAA and PAd.xlsx", replace)
...
percent_n percsign("%") iqrmiddle(",") sdleft(" (±") sdright(")") onecol total(before) ///
saving("`output_dir'/All demographcis by AAd and PAd.xlsx", replace)
...
percent_n percsign("%") iqrmiddle(",") sdleft(" (±") sdright(")") onecol total(before) ///
saving("`output_dir'/All demographcis by AA_d.xlsx", replace)
...
saving("`output_dir'/CHEST-Age by PA_d simple.xlsx", replace)
...
percent_n percsign("%") iqrmiddle(",") sdleft(" (±") sdright(")") onecol ///
saving("`output_dir'/CHEST-Age by PA_AA simple.xlsx", replace)
...
percent_n percsign("%") iqrmiddle(",") sdleft(" (±") sdright(")") onecol ///
saving("`output_dir'/CHEST-PAd and PAAA by decade.xlsx", replace)
...
percent_n percsign("%") iqrmiddle(",") sdleft(" (±") sdright(")") onecol ///
saving("`output_dir'/CHEST-Age by PA_d.xlsx", replace)
...
percent_n percsign("%") iqrmiddle(",") sdleft(" (±") sdright(")") onecol ///
saving("`output_dir'/CHEST-Age by PA_AA.xlsx", replace)
...
percent_n percsign("%") iqrmiddle(",") sdleft(" (±") sdright(")") onecol total(before) ///
saving("`output_dir'/CHEST-All demographcis by PA_d.xlsx", replace)
...
percent_n percsign("%") iqrmiddle(",") sdleft(" (±") sdright(")") onecol total(before) ///
saving("`output_dir'/CHEST-All demographcis by PA_AA.xlsx", replace)
...
graph export "`output_dir'/Sensitivity Regression Effect of IPW.png", as(png) name("Graph") replace
...
outreg2 using "`output_dir'/IRRs by Ratio and Diam", excel replace eform dec(2) pdec(3) stat(coef ci pval) title(Independent Associations with Enlarged PA and PAAA) label
...
outreg2 using "`output_dir'/IRRs by Ratio and Diam", excel append eform dec(2) pdec(3) stat(coef ci pval) title(Independent Associations with Enlarged PA and PAAA) label
*/
...
outreg2 [mpad_bi_decade mpaaa_bi_decade aa_bi_decade ] using "`output_dir'/MPAD MPAAA AA regressions", word replace keep(0.age_bi_decade 1.age_bi_decade 2.age_bi_decade) dec(3) stat(coef ci pval) title(Change in Size by Age) label
...
graph export "`output_dir'/Unadjusted KM PAd.png", as(png) name("Graph") replace
...
graph export "`output_dir'/Unadjusted Hazard by PAd.png", as(png) name("Graph") replace
...
graph export "`output_dir'/Adjusted Age Sex Hazard by PAd.png", as(png) name("Graph") replace
...
graph export "`output_dir'/No Known Comorb Unadjusted KM PAd.png", as(png) name("Graph") replace
...
graph export "`output_dir'/Known Comorb Unadjusted KM PAd.png", as(png) name("Graph") replace
...
graph export "`output_dir'/Unadjusted KM PAAA.png", as(png) name("Graph") replace
...
graph export "`output_dir'/Unadjusted Hazard by PAAA.png", as(png) name("Graph") replace
...
graph export "`output_dir'/Adjusted Age Sex Hazard by PAAA.png", as(png) name("Graph") replace
...
graph export "`output_dir'/No Known Comorb Unadjusted KM PAAA.png", as(png) name("Graph") replace
...
graph export "`output_dir'/Known Comorb Unadjusted KM PAAA.png", as(png) name("Graph") replace
...
graph export "`output_dir'/AgeSex KM PAAA.png", as(png) name("Graph") replace
...
graph export "`output_dir'/AgeSexComorb KM PAAA.png", as(png) name("Graph") replace
estat phtest, detail //really just the decades that violate proportional hazards
...
graph export "`output_dir'/ComorbidityVennDiagram.png", as(png) name("Graph") replace

//output regression coefficients to a table.
outreg2 [unadjusted_ratio_full unadjusted_ratio_comorb unadjusted_ratio_no_comorb ratio_model1_full ratio_model1_comorb ratio_model1_no_comorb ratio_model2_full ratio_model2_comorb ratio_model2_no_comorb ] using "`output_dir'/ratio_HRs_by_model", excel replace keep(enlargedratio) eform dec(3) stat(coef ci pval) title(HR of Mortality) label

//regression coefficients for the individual comorbidities
outreg2 [ratio_unadjusted_chf ratio_unadjusted_pulm ratio_unadjusted_pvasc ratio_model_1_chf ratio_model_1_pulm ratio_model_1_pvasc ratio_model_2_chf ratio_model_2_pulm ratio_model_2_pvasc] using "`output_dir'/indiv_comorb_ratio_HRs_by_model", excel replace keep(enlargedratio) eform dec(3) stat(coef ci pval) title(HR of Mortality) label
...
//output regression coefficients to a table.
outreg2 [unadjusted_pa_full unadjusted_pa_comorb unadjusted_pa_no_comorb pa_model1_full pa_model1_comorb pa_model1_no_comorb pa_model2_full pa_model2_comorb pa_model2_no_comorb] using "`output_dir'/pa_HRs_by_model", excel replace keep(enlargedpa) eform dec(3) stat(coef ci pval) title(HR of Mortality) label

outreg2 [pa_unadjusted_chf pa_unadjusted_pulm pa_unadjusted_pvasc pa_model_1_chf pa_model_1_pulm pa_model_1_pvasc pa_model_2_chf pa_model_2_pulm pa_model_2_pvasc] using "`output_dir'/indiv_comorb_pa_HRs_by_model", excel replace keep(enlargedpa) eform dec(3) stat(coef ci pval) title(HR of Mortality) label
...
graph export "`output_dir'/Combined HR Unadjusted Model1 Model2.png", as(png) name("Graph") replace
...
graph export "`output_dir'/No SG - Combined HR Unadjusted Model1 Model2.png", as(png) name("Graph") replace
...
graph export "`output_dir'/HR of Age by Decade.png", as(png) name("Graph") replace
*/
...
graph export "`output_dir'/PA Confusion Matrix KM age male.png", as(png) name("Graph") replace
...
graph export "`output_dir'/PA Confusion Matrix KM age male comorbs.png", as(png) name("Graph") replace
...
graph export "`output_dir'/PA AA Confusion Matrix KM.png", as(png) name("Graph") replace
...
graph export "`output_dir'/PA AA Confusion Matrix KM age male.png", as(png) name("Graph") replace
...
graph export "`output_dir'/PA AA Confusion Matrix KM age male comorbs.png", as(png) name("Graph") replace
...
graph export "`output_dir'/PAd all ages KM.png", as(png) name("Graph") replace
...
graph export "`output_dir'/PAd age below 50 KM.png", as(png) name("Graph") replace
...
graph export "`output_dir'/PAd age 50 75 KM.png", as(png) name("Graph") replace
...
graph export "`output_dir'/PAd age above 65 KM.png", as(png) name("Graph") replace
...
graph export "`output_dir'/PAd HR at each age.png", as(png) name("Graph") replace
...
graph export "`output_dir'/PAAA All Ages.png", as(png) name("Graph") replace
...
graph export "`output_dir'/PAAA age below 50 KM.png", as(png) name("Graph") replace
...
graph export "`output_dir'/PAAA age 50 65 KM.png", as(png) name("Graph") replace
...
graph export "`output_dir'/PAAA age above 65 KM.png", as(png) name("Graph") replace
...
graph export "`output_dir'/PAAA HR at each age.png", as(png) name("Graph") replace
...
graph export "`output_dir'/AA age below 50 KM.png", as(png) name("Graph") replace
...
graph export "`output_dir'/AA age 50 65 KM.png", as(png) name("Graph") replace
...
graph export "`output_dir'/AA age above 65 KM.png", as(png) name("Graph") replace
...
graph export "`output_dir'/AA HR at each age.png", as(png) name("Graph") replace
...
graph export "`output_dir'/Hist Time of last follow-up PAd status.png", as(png) name("Graph") replace
hist lastfollowupyear if death == 0, by(enlargedratio age_bi_decade) xtitle("Time of deaths (years)")
graph export "`output_dir'/Hist Time of last follow-up PAAA status.png", as(png) name("Graph") replace
...
scheme(white_tableau)
graph export "`output_dir'/Frequency PA_AA by Age Group.png", as(png) name("Graph") replace
...
scheme(white_tableau)
graph export "`output_dir'/Frequency PA_d by Age Group.png", as(png) name("Graph") replace

//Not sure if its worth combining these... but it actually seems like the labels might throw people off.
//graph save "`output_dir'/temp_mpaaa_old.gph", replace
//graph combine "`output_dir'/temp_mpaaa_old.gph" "`output_dir'/temp_mpaaa_mid.gph" "`output_dir'/temp_mpaaa_young.gph", ///
//xcommon col(1)
...
graph export "`output_dir'/HR PAAA Splines - Whole Cohort Age-Z-score.png", as(png) name("Graph") replace
restore
...
graph export "`output_dir'/HR PAd Splines - Whole Cohort Age-Z-score.png", as(png) name("Graph") replace
...
graph export "`output_dir'/HR PAAA Splines - Whole Cohort Unadj.png", as(png) name("Graph") replace
restore
*/
...
graph export "`output_dir'/HR PAAA Splines - Whole Cohort Adj AgeSex.png", as(png) name("Graph") replace
restore
...
graph export "`output_dir'/HR PAAA Splines - Whole Cohort Adj AgeSexComorb.png", as(png) name("Graph") replace
restore
*/
...
graph export "`output_dir'/HR PAAA Splines - Age less 50 Adj AgeSex.png", as(png) name("Graph") replace
restore
...
graph export "`output_dir'/HR PAAA Splines - Age less 50 Adj AgeSexComorb.png", as(png) name("Graph") replace
restore
*/
...
graph export "`output_dir'/HR PAAA Splines - Age 50-65 Adj AgeSex.png", as(png) name("Graph") replace
restore
...
graph export "`output_dir'/HR PAAA Splines - Age 50-65 Adj AgeSexComorb.png", as(png) name("Graph") replace
restore
*/
...
graph export "`output_dir'/HR PAAA Splines - Age 65plus Adj AgeSex.png", as(png) name("Graph") replace
...
graph export "`output_dir'/HR PAAA Splines - Age 65plus Adj AgeSexComorb.png", as(png) name("Graph") replace
restore
*/
...
graph export "`output_dir'/HR PAAA Splines - Age below 50 Adj AgeSexComorb.png", as(png) name("Graph") replace
restore
...
xblc rc*, covname(mpaaa_rounded) at(`r(levels)') reference(0.77) eform generate(pa or lb ub)
twoway (line lb ub pa, sort lc(black black) lp(longdash longdash)) (line or pa, sort lc(black) lp(l)) if inrange(pa,0.65,1.3), yscale(log extend) legend(off) scheme(cleanplots) xlabel(0.65(0.05)1.3) xmtick(0.65(0.05)1.3) ylabel(1 2 4 8, angle(horiz) format(%2.1fc)) ytitle("Hazard Ratio of Mortality") xtitle("PA:AA") title("HR for mortality; Age 69+; adjusted for age(decade), sex, and comorbidities") yline(1, lp("shortdash") lc(gs10)) xline(0.9, lp("shortdash_dot") lc(gs10)) note("Sample mean (PA:AA = 0.85) taken as reference. Restricted cubic splines with 4 knots as described in Harrell (2001)" "Lines added at traditional threshold of abnormal (0.9) and HR = 1. Dashed line = 95% Confidence interval")
graph export "`output_dir'/HR PAAA Splines - Age 50 plus Adj AgeSexComorb.png", as(png) name("Graph") replace
restore
*/
...
graph export "`output_dir'/HR PAd Splines - Whole Cohort Unadj.png", as(png) name("Graph") replace
restore
*/
...
graph export "`output_dir'/HR PAd Splines - Whole Cohort Adj AgeSex.png", as(png) name("Graph") replace
restore
...
graph export "`output_dir'/HR PAd Splines - Whole Cohort Adj AgeSexComorb.png", as(png) name("Graph") replace
restore
*/
...
graph export "`output_dir'/HR PAd Splines - Age less 50 Adj AgeSex.png", as(png) name("Graph") replace
restore
...
graph export "`output_dir'/HR PAd Splines - Age less 50 Adj AgeSexComorb.png", as(png) name("Graph") replace
restore
*/
...
graph export "`output_dir'/HR PAd Splines - Age 50-65 Adj AgeSex.png", as(png) name("Graph") replace
restore
...
graph export "`output_dir'/HR PAd Splines - Age 50-65 Adj AgeSexComorb.png", as(png) name("Graph") replace
restore
*/
...
graph export "`output_dir'/HR PAd Splines - Age 65 plus Adj AgeSex.png", as(png) name("Graph") replace
restore
...
graph export "`output_dir'/HR PAd Splines - Age 65 plus Adj AgeSexComorb.png", as(png) name("Graph") replace
restore
*/
...
graph export "`output_dir'/HR PAd Splines - Age below 69 Adj AgeSexComorb.png", as(png) name("Graph") replace
restore
...
xblc rc*, covname(sex_norm_mpad) at(`r(levels)') reference(25.5) eform generate(pa or lb ub)
twoway (line lb ub pa, sort lc(black black) lp(longdash longdash)) (line or pa, sort lc(black) lp(l)) if inrange(pa,17.5,41.5), yscale(log extend) scheme(cleanplots) legend(off) xlabel(17.5(3)41.5) xmtick(17.5(1)41.5) ylabel(0.5 1 2 4 8, angle(horiz) format(%2.1fc)) ytitle("Hazard Ratio of Mortality") xtitle("Sex-Adjusted PA_d (mm)") title("HR for mortality; Age 69+; adjusted for age(decade), sex, and comorbidities") yline(1, lp("shortdash") lc(gs10)) xline(28, lp("shortdash_dot") lc(gs10)) note("Sample mean (PA_d = 25.5mm) taken as reference. Restricted cubic splines with 4 knots as described in Harrell (2001)" "Lines added at traditional threshold of abnormal (28mm) and HR = 1. Dashed line = 95% Confidence interval")
graph export "`output_dir'/HR PAd Splines - Age 69 plus Adj AgeSexComorb.png", as(png) name("Graph") replace
restore
*/
*/
...
graph export "`output_dir'/Predicted HR Age and PAd w 3 knot splines.png", as(png) name("Graph") replace
restore
...
graph export "`output_dir'/Predicted HR Age and PAAA w 3 knot splines.png", as(png) name("Graph") replace
restore
...
graph export "`output_dir'/HR PAAA by age strat with CI.png", as(png) name("Graph") replace
...
graph export "`output_dir'/HR MPAD by age strat with CI.png", as(png) name("Graph") replace
...
graph save "`output_dir'/temp_mpaaa_young.gph", replace
...
heatplot masked_hr_mpaaa_mid mid_axis mpaaa_mid, ///
 ...
 ytitle("") ///
 ylabel(,labsize(vlarge) angle(90))
graph save "`output_dir'/temp_mpaaa_mid.gph", replace
...
graph combine "`output_dir'/temp_mpaaa_young.gph" "`output_dir'/temp_mpaaa_mid.gph" "`output_dir'/temp_mpaaa_old.gph", ///
 xcommon col(1) ///
 imargin(0 0 0 0) graphregion(margin(l=22 r=22)) ///
...
graph export "`output_dir'/HR by Age strat and PAAA w 3 knot spline.png", as(png) name("Graph") replace
...
heatplot masked_hr_mpad_young young_axis mpad_young, ///
 ...
 ytitle("") ///
 ylabel(,labsize(vlarge) angle(90))
graph save "`output_dir'/temp_mpad_young.gph", replace
...
heatplot masked_hr_mpad_mid mid_axis mpad_mid, ///
 ...
 ytitle("") ///
 ylabel(,labsize(vlarge) angle(90))
graph save "`output_dir'/temp_mpad_mid.gph", replace
...
graph save "`output_dir'/temp_mpad_old.gph", replace

graph combine "`output_dir'/temp_mpad_young.gph" "`output_dir'/temp_mpad_mid.gph" "`output_dir'/temp_mpad_old.gph", ///
 xcommon col(1) ///
 imargin(0 0 0 0) graphregion(margin(l=22 r=22)) ///
...
graph export "`output_dir'/HR by Age strat and PAd w 3 knot spline.png", as(png) name("Graph") replace
...
graph export "`output_dir'/Predicted HR Strat-Age and PAAA w 3 knot spline.png", as(png) name("Graph") replace
*/
...
heatplot mpad_model_synth i.age_bi_decade sex_norm_mpad, aspectratio(0.7) color(YlOrRd) xlabel(15(05)40, angle(vertical) labsize(3)) xbwidth(2) xtitle("Sex-Adjusted PA_d (mm)", size(4)) ytitle("Age Category", size(4))  ramp(right format(%3.2f) space(18) subtitle("Predicted" "HR of" "Mortality", size(small) justification(center)) label(1(0.5)5.5, labsize(3))) p(lcolor(black%10) lwidth(*0.15)) clip
graph export "`output_dir'/Predicted HR Age Cat and PAd w 4 knot splines.png", as(png) name("Graph") replace
